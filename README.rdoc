...
Once you've downloaded TestDrive, open up TestDrive.conf.yml, and make sure the settings look alright to you.
...
Oh, and Git - but as a MarkUs developer, you probably already have that.  ;)
